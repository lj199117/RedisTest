...
public class UtilJson {
	...
	public static String writerWithDefaultPrettyPrinter0(Object value) {
		try {
			return mapper0.writerWithDefaultPrettyPrinter().writeValueAsString(value);
		} catch (IOException e) {
			throw new IllegalArgumentException(e);
		}
	}
	...
	public static ObjectMapper newObjectMapper() {
		...
		result.setDateFormat(new UTCSimpleDateFormat());
		return result;
	}
	...
	public static <T> List<T> readList(String content, Class<?> collectionClass, Class<T> elementClass) {
		...
		try {
			return mapper.readValue(content,
					mapper.getTypeFactory().constructCollectionLikeType(collectionClass == null ? List.class : collectionClass, elementClass));
		} catch (IOException e) {
			throw new IllegalStateException(e);
		}
	}
	...
	public static boolean equals(Object obj1, Object obj2) {
		...
		return UtilObj.equals(writeValueAsString(obj1), writeValueAsString(obj2));
	}
	...
	public static String toString(Object obj) {
		try {
			...
			if (ExceptionCounter.global.inLimit(e)) {
				logger.info("[联系开发者]转换为json异常：{}", obj, e);
			} else {
				logger.debug("[联系开发者]转换为json异常：{}", obj, e);
			}
		}
